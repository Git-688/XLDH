  ...
  <table style="border-collapse: collapse; white-space: nowrap;">
    <tr>
      <td style="padding: 200 520px; text-align: center; vertical-align: top;">
        <img src="https://tc688.ccwu.cc/file/星聚导航/zstp/网站主页.webp" alt="网站主页" width="650" style="border-radius: 80px; box-shadow:5 0 20px 80px rgba(0,0,0,0.15); display: block;">
