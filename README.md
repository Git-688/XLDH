<div align="center">
  ...
  <h1>⭐️ 星聚导航</h1>
  <p>一款极简高效的现代个人导航页，该项目是基于免费公开的（Git项目、API、轻量数据库）基础上建设的。Fork后可以根据自己的意向进行修改/优化/配置等等。</p>
  ...
  ![Website](https://img.shields.io/website?url=https%3A%2F%2Fx-jdh688.ccwu.cc-7ED321&label=网站状态)
