...
<details>
<summary><b>📸 点击展开查看全部功能截图</b> (共 11 张)</summary>
<div style="display: flex; flex-wrap: wrap; gap: 12px; justify-content: center; padding: 12px 0;">
  <!-- 每项宽度约 23%，保证一行 4 个 -->
  <div style="flex: 0 0 calc(25% - 12px); min-width: 130px; text-align: center;">
    <img src="https://tc688.ccwu.cc/file/星聚导航/zstp/网站主页.webp" alt="主页" style="width: 100%; border-radius: 10px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
    <div style="font-size: 13px; font-weight: 500; color: #333; margin-top: 4px;">🏠 主页</div>
  </div>
  <div style="flex: 0 0 calc(25% - 12px); min-width: 130px; text-align: center;">
    ...
    <div style="font-size: 13px; font-weight: 500; color: #333; margin-top: 4px;">📂 分类导航</div>
  </div>
  <div style="flex: 0 0 calc(25% - 12px); min-width: 130px; text-align: center;">
    ...
    <div style="font-size: 13px; font-weight: 500; color: #333; margin-top: 4px;">📌 页脚</div>
  </div>
  <div style="flex: 0 0 calc(25% - 12px); min-width: 130px; text-align: center;">
    ...
    <div style="font-size: 13px; font-weight: 500; color: #333; margin-top: 4px;">📱 侧滑栏</div>
  </div>
  <div style="flex: 0 0 calc(25% - 12px); min-width: 130px; text-align: center;">
    ...
    <div style="font-size: 13px; font-weight: 500; color: #333; margin-top: 4px;">🎵 内置音乐</div>
  </div>
  <div style="flex: 0 0 calc(25% - 12px); min-width: 130px; text-align: center;">
    ...
    <div style="font-size: 13px; font-weight: 500; color: #333; margin-top: 4px;">🔗 外部音乐</div>
  </div>
  <div style="flex: 0 0 calc(25% - 12px); min-width: 130px; text-align: center;">
    ...
    <div style="font-size: 13px; font-weight: 500; color: #333; margin-top: 4px;">📊 排行榜</div>
  </div>
  <div style="flex: 0 0 calc(25% - 12px); min-width: 130px; text-align: center;">
    ...
    <div style="font-size: 13px; font-weight: 500; color: #333; margin-top: 4px;">💬 评论系统</div>
  </div>
  <div style="flex: 0 0 calc(25% - 12px); min-width: 130px; text-align: center;">
    ...
    <div style="font-size: 13px; font-weight: 500; color: #333; margin-top: 4px;">☁️ 天气预报</div>
  </div>
  <div style="flex: 0 0 calc(25% - 12px); min-width: 130px; text-align: center;">
    ...
    <div style="font-size: 13px; font-weight: 500; color: #333; margin-top: 4px;">📝 网站投稿</div>
  </div>
  <div style="flex: 0 0 calc(25% - 12px); min-width: 130px; text-align: center;">
    ...
    <div style="font-size: 13px; font-weight: 500; color: #333; margin-top: 4px;">ℹ️ 关于网站</div>
  </div>
</div>
</details>
