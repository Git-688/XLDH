...
<div align="center">
  <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 24px; max-width: 1200px; margin: 0 auto; padding: 10px;">
    <div style="text-align: center;">
      <img src="https://tc688.ccwu.cc/file/星聚导航/zstp/网站主页.webp" alt="网站主页" style="width: 100%; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.15);">
      <div style="font-weight: bold; font-size: 14px; color: #333; margin-top: 6px;">网站主页</div>
    </div>
    <div style="text-align: center;">
      <img src="https://tc688.ccwu.cc/file/星聚导航/zstp/分类导航.webp" alt="分类导航" style="width: 100%; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.15);">
      <div style="font-weight: bold; font-size: 14px; color: #333; margin-top: 6px;">分类导航</div>
    </div>
    <div style="text-align: center;">
      <img src="https://tc688.ccwu.cc/file/星聚导航/zstp/网站页脚.webp" alt="网站页脚" style="width: 100%; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.15);">
      <div style="font-weight: bold; font-size: 14px; color: #333; margin-top: 6px;">网站页脚</div>
    </div>
    <div style="text-align: center;">
      <img src="https://tc688.ccwu.cc/file/星聚导航/zstp/侧滑栏.webp" alt="侧滑栏" style="width: 100%; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.15);">
      <div style="font-weight: bold; font-size: 14px; color: #333; margin-top: 6px;">侧滑栏</div>
    </div>
    <div style="text-align: center;">
      <img src="https://tc688.ccwu.cc/file/星聚导航/zstp/内部音乐.webp" alt="内部音乐" style="width: 100%; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.15);">
      <div style="font-weight: bold; font-size: 14px; color: #333; margin-top: 6px;">内部音乐</div>
    </div>
    <div style="text-align: center;">
      <img src="https://tc688.ccwu.cc/file/星聚导航/zstp/外部音乐.webp" alt="外部音乐" style="width: 100%; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.15);">
      <div style="font-weight: bold; font-size: 14px; color: #333; margin-top: 6px;">外部音乐</div>
    </div>
    <div style="text-align: center;">
      <img src="https://tc688.ccwu.cc/file/星聚导航/zstp/排行榜.webp" alt="排行榜" style="width: 100%; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.15);">
      <div style="font-weight: bold; font-size: 14px; color: #333; margin-top: 6px;">排行榜</div>
    </div>
    <div style="text-align: center;">
      <img src="https://tc688.ccwu.cc/file/星聚导航/zstp/评论系统.webp" alt="评论系统" style="width: 100%; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.15);">
      <div style="font-weight: bold; font-size: 14px; color: #333; margin-top: 6px;">评论系统</div>
    </div>
    <div style="text-align: center;">
      <img src="https://tc688.ccwu.cc/file/星聚导航/zstp/天气预报.webp" alt="天气预报" style="width: 100%; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.15);">
      <div style="font-weight: bold; font-size: 14px; color: #333; margin-top: 6px;">天气预报</div>
    </div>
    <div style="text-align: center;">
      <img src="https://tc688.ccwu.cc/file/星聚导航/zstp/网站投稿.webp" alt="网站投稿" style="width: 100%; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.15);">
      <div style="font-weight: bold; font-size: 14px; color: #333; margin-top: 6px;">网站投稿</div>
    </div>
    <div style="text-align: center;">
      <img src="https://tc688.ccwu.cc/file/星聚导航/zstp/关于网站.webp" alt="关于网站" style="width: 100%; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.15);">
