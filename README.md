...
<div align="center" style="display: flex; flex-wrap: wrap; gap: 12px; justify-content: center; margin-bottom: 20px;">
  <div style="width: 22%; min-width: 130px; text-align: center;">
    <img src="https://tc688.ccwu.cc/file/星聚导航/zstp/网站主页.webp" alt="主页" width="100%" style="border-radius: 10px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
    <div style="font-size: 13px; font-weight: 500; margin-top: 4px;">🏠 主页</div>
  </div>
  <div style="width: 22%; min-width: 130px; text-align: center;">
    <img src="https://tc688.ccwu.cc/file/星聚导航/zstp/分类导航.webp" alt="分类导航" width="100%" style="border-radius: 10px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
    <div style="font-size: 13px; font-weight: 500; margin-top: 4px;">📂 分类导航</div>
  </div>
  <div style="width: 22%; min-width: 130px; text-align: center;">
    <img src="https://tc688.ccwu.cc/file/星聚导航/zstp/侧滑栏.webp" alt="侧滑栏" width="100%" style="border-radius: 10px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
    <div style="font-size: 13px; font-weight: 500; margin-top: 4px;">📱 侧滑栏</div>
  </div>
  <div style="width: 22%; min-width: 130px; text-align: center;">
    <img src="https://tc688.ccwu.cc/file/星聚导航/zstp/网站页脚.webp" alt="网站页脚" width="100%" style="border-radius: 10px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
    <div style="font-size: 13px; font-weight: 500; margin-top: 4px;">📌 页脚</div>
  </div>
</div>
...
<div align="center" style="display: flex; flex-wrap: wrap; gap: 12px; justify-content: center; margin-bottom: 20px;">
  <div style="width: 22%; min-width: 130px; text-align: center;">
    <img src="https://tc688.ccwu.cc/file/星聚导航/zstp/内部音乐.webp" alt="内部音乐" width="100%" style="border-radius: 10px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
    <div style="font-size: 13px; font-weight: 500; margin-top: 4px;">🎵 内置音乐</div>
  </div>
  <div style="width: 22%; min-width: 130px; text-align: center;">
    <img src="https://tc688.ccwu.cc/file/星聚导航/zstp/外部音乐.webp" alt="外部音乐" width="100%" style="border-radius: 10px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
    <div style="font-size: 13px; font-weight: 500; margin-top: 4px;">🔗 外部音乐</div>
  </div>
  <div style="width: 22%; min-width: 130px; text-align: center;">
    <img src="https://tc688.ccwu.cc/file/星聚导航/zstp/排行榜.webp" alt="排行榜" width="100%" style="border-radius: 10px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
    <div style="font-size: 13px; font-weight: 500; margin-top: 4px;">📊 排行榜</div>
  </div>
  <!-- 此处只有3张，自动靠左，第四格留空 -->
</div>
...
<div align="center" style="display: flex; flex-wrap: wrap; gap: 12px; justify-content: center; margin-bottom: 20px;">
  <div style="width: 22%; min-width: 130px; text-align: center;">
    <img src="https://tc688.ccwu.cc/file/星聚导航/zstp/天气预报.webp" alt="天气预报" width="100%" style="border-radius: 10px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
    <div style="font-size: 13px; font-weight: 500; margin-top: 4px;">☁️ 天气预报</div>
  </div>
  <div style="width: 22%; min-width: 130px; text-align: center;">
    <img src="https://tc688.ccwu.cc/file/星聚导航/zstp/评论系统.webp" alt="评论系统" width="100%" style="border-radius: 10px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
    <div style="font-size: 13px; font-weight: 500; margin-top: 4px;">💬 评论系统</div>
  </div>
  <div style="width: 22%; min-width: 130px; text-align: center;">
    <img src="https://tc688.ccwu.cc/file/星聚导航/zstp/网站投稿.webp" alt="网站投稿" width="100%" style="border-radius: 10px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
    <div style="font-size: 13px; font-weight: 500; margin-top: 4px;">📝 网站投稿</div>
  </div>
  <div style="width: 22%; min-width: 130px; text-align: center;">
    <img src="https://tc688.ccwu.cc/file/星聚导航/zstp/关于网站.webp" alt="关于网站" width="100%" style="border-radius: 10px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
    <div style="font-size: 13px; font-weight: 500; margin-top: 4px;">ℹ️ 关于网站</div>
  </div>
</div>
