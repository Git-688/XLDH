...
<div align="center" style="margin-top: 20px;">
  <div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 20px;">
    ...
    <div style="width: 200px; text-align: center;">
      <img src="https://tc688.ccwu.cc/file/星聚导航/zstp/网站主页.webp" alt="网站主页"
           style="width: 100%; height: 150px; object-fit: cover; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.15); display: block;">
      <div style="font-weight: bold; font-size: 14px; color: #333; margin-top: 6px;">网站主页</div>
    </div>
    <!-- 分类导航 -->
    <div style="width: 200px; text-align: center;">
      <img src="https://tc688.ccwu.cc/file/星聚导航/zstp/分类导航.webp" alt="分类导航"
           style="width: 100%; height: 150px; object-fit: cover; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.15); display: block;">
      <div style="font-weight: bold; font-size: 14px; color: #333; margin-top: 6px;">分类导航</div>
    </div>
    <!-- 网站页脚 -->
    <div style="width: 200px; text-align: center;">
      <img src="https://tc688.ccwu.cc/file/星聚导航/zstp/网站页脚.webp" alt="网站页脚"
           style="width: 100%; height: 150px; object-fit: cover; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.15); display: block;">
      <div style="font-weight: bold; font-size: 14px; color: #333; margin-top: 6px;">网站页脚</div>
    </div>
    <!-- 侧滑栏 -->
    <div style="width: 200px; text-align: center;">
      <img src="https://tc688.ccwu.cc/file/星聚导航/zstp/侧滑栏.webp" alt="侧滑栏"
           style="width: 100%; height: 150px; object-fit: cover; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.15); display: block;">
      <div style="font-weight: bold; font-size: 14px; color: #333; margin-top: 6px;">侧滑栏</div>
    </div>
    <!-- 内部音乐 -->
    <div style="width: 200px; text-align: center;">
      <img src="https://tc688.ccwu.cc/file/星聚导航/zstp/内部音乐.webp" alt="内部音乐"
           style="width: 100%; height: 150px; object-fit: cover; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.15); display: block;">
      <div style="font-weight: bold; font-size: 14px; color: #333; margin-top: 6px;">内部音乐</div>
    </div>
    <!-- 外部音乐 -->
    <div style="width: 200px; text-align: center;">
      <img src="https://tc688.ccwu.cc/file/星聚导航/zstp/外部音乐.webp" alt="外部音乐"
           style="width: 100%; height: 150px; object-fit: cover; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.15); display: block;">
      <div style="font-weight: bold; font-size: 14px; color: #333; margin-top: 6px;">外部音乐</div>
    </div>
    <!-- 排行榜 -->
    <div style="width: 200px; text-align: center;">
      <img src="https://tc688.ccwu.cc/file/星聚导航/zstp/排行榜.webp" alt="排行榜"
           style="width: 100%; height: 150px; object-fit: cover; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.15); display: block;">
      <div style="font-weight: bold; font-size: 14px; color: #333; margin-top: 6px;">排行榜</div>
    </div>
    <!-- 评论系统 -->
    <div style="width: 200px; text-align: center;">
      <img src="https://tc688.ccwu.cc/file/星聚导航/zstp/评论系统.webp" alt="评论系统"
           style="width: 100%; height: 150px; object-fit: cover; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.15); display: block;">
      <div style="font-weight: bold; font-size: 14px; color: #333; margin-top: 6px;">评论系统</div>
    </div>
    <!-- 天气预报 -->
    <div style="width: 200px; text-align: center;">
      <img src="https://tc688.ccwu.cc/file/星聚导航/zstp/天气预报.webp" alt="天气预报"
           style="width: 100%; height: 150px; object-fit: cover; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.15); display: block;">
      <div style="font-weight: bold; font-size: 14px; color: #333; margin-top: 6px;">天气预报</div>
    </div>
    <!-- 网站投稿 -->
    <div style="width: 200px; text-align: center;">
      <img src="https://tc688.ccwu.cc/file/星聚导航/zstp/网站投稿.webp" alt="网站投稿"
           style="width: 100%; height: 150px; object-fit: cover; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.15); display: block;">
      <div style="font-weight: bold; font-size: 14px; color: #333; margin-top: 6px;">网站投稿</div>
    </div>
    <!-- 关于网站 -->
    <div style="width: 200px; text-align: center;">
      <img src="https://tc688.ccwu.cc/file/星聚导航/zstp/关于网站.webp" alt="关于网站"
           style="width: 100%; height: 150px; object-fit: cover; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.15); display: block;">
      <div style="font-weight: bold; font-size: 14px; color: #333; margin-top: 6px;">关于网站</div>
    </div>
  </div>
  <p style="margin-top: 16px;">📸 截图仅示意，实际效果请访问 <a href="shturl.cc/30XQNKS3hf9de">在线体验</a></p>
</div>
## 💰 赞赏项目
