...
class CommentModule {
    ...
    _initWaline() {
        ...
        if (typeof Waline === 'undefined') {
            container.innerHTML = '<div class="waline-comment-fallback" style="padding:20px;text-align:center;color:#999;">Waline 库未加载，请检查网络。</div>';
            return null;
        }
        try {
            const instance = Waline.init({ el, serverURL, ...walineOptions });
    ...
    async open() {
        ...
        if (!this.instance) {
            ...
            this.instance = this._initWaline();
            if (this.instance) {
                setTimeout(() => {
