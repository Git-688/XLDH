...
const APP_CONSTANTS = {
    ...
    IMAGE: {
        ...
        ICON_SOURCES: [
            function(d) { return `https://icon.horse/icon/${d}?size=512&format=webp`; },
            function(d) { return `https://icon.horse/icon/${d}?size=256&format=webp`; },
            function(d) { return `https://icon.horse/icon/${d}?size=128`; },
            function(d) { return `https://www.google.com/s2/favicons?domain=${d}&sz=256`; },
            function(d) { return `https://www.google.com/s2/favicons?domain=${d}&sz=128`; },
            function(d) { return `https://favicon.yandex.net/favicon/${d}`; },
