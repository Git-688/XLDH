...
class MusicPlayer {
    ...
    initializeProperties() {
        ...
        const apis = ['netease', 'qq', 'kg', 'kuwo', 'migu', 'qishui', 'local'];
    ...
    toggleSearchMode(apiId) {
        if (apiId === 'migu' || apiId === 'local') {
            window.toast?.show('该平台不支持搜索', 'info');
            return;
        }
